...
.. attention:: PicoScenes平台非常荣幸地得到美国国家仪器(NI)公司的认可与支持——“**PicoScenes平台补齐了NI公司在Wi-Fi ISAC领域的不足**”。为支持更多用户基于PicoScenes平台及NI USRP系列产品进行Wi-Fi/5G/6G ISAC领域的研究与应用, NI公司(中国)与PicoScenes平台的商业合作伙伴“西安煊研信息技术有限公司”达成合作:**对从该公司出售的每个NI品牌或Ettus品牌USRP系统软件无线电设备(B/N/E/X系列,独立机器或"母板+子板套件),免费赠送一份PSLP-PRO-DBL许可证**。
