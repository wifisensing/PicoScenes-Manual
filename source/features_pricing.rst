...
.. csv-table::
    ...
    "PicoScenes MATLAB Toolbox","Parsing the .csi files in MATLAB. See :doc:`/matlab`.","**✓**","**✓**"
    "Plugins Development","Allowing users to develop complex and dedicated ISAC measurement protocols, like round-trip CSI measurements or spectrum scanning. See :doc:`/plugin` ","**✓**","**✓**"
