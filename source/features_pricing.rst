...
.. csv-table::
    ...
    "Multi-Channel Splitting and Stitching", "Combining two half-rate sampling channels into a full-rate channel, e.g., achieving up to 400 MHz bandwidth with a single USRP X310 (200 MHz rate max.). See :ref:`dual-split-merge`", "","**✓**"
