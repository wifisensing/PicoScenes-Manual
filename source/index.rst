...
- For SDR, PicoScenes is the *only* platform that **can turn your SDR device into a SDR-based Wi-Fi NIC**, *i.e.*, transmitting/receiving Wi-Fi frames and measuring their CSI in real time just like a full-functional Wi-Fi NIC. The core technology behind is a multi-standard compliant Wi-Fi baseband implementation. It has four major highlights: full protocol compliance, rich PHY-layer control, complete and all-stage PHY-layer information, and high performance. 
