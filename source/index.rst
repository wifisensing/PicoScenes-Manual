...
- For SDR, PicoScenes is the *only* platform that **turns your SDR devices into SDR-based Wi-Fi NICs**, *i.e.*, transmitting/receiving all-format/all-bandwidth Wi-Fi frames and measuring their CSI in real time. It has four major highlights: protocol support, PHY-layer control, performance and virtual SDR. 

  - PicoScenes Wi-Fi baseband implementation **covers almost all the advanced technical features**, including all-format (supporting 802.11a/g/n/ac/ax), all-bandwidth (20/40/80/160 MHz), all-coding (LDPC and BCC), all-MCS(MCS 0 to 11), and up to 4x4 MIMO supports. 
