...
Some suggestions based on our previous experience:
    ...
    - As clearly stated in `Multiple USRP configuration <https://files.ettus.com/manual/page_multiple.html>`_, UHD only supports combine multiple USRPs of the same model, and currently only N2x0 and X3x0 series are combination-ready.
