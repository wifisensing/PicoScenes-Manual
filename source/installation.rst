...
Some suggestions based on our previous experience:
    ...
    - As clearly stated in `Multiple USRP configurations <https://files.ettus.com/manual/page_multiple.html>`, UHD only supports combine multiple USRPs of the same model, and currently only N210 and X310 are combination-ready.
