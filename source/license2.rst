...
.. csv-table::
    ...
    "Operating at non-Standard Channel (Carrier Frequency)","*Frequency must be supported by hardware.* See :ref:`non-standard-tx-rx`.","✓([2.3-2.6] GHz only)","**✓**"
    "Operating with Non-Standard Bandwidth (Sampling Rate)","*Sampling rate must be supported by hardware.* See :ref:`non-standard-tx-rx`.","✓(10 MHz and 30 MHz only)","**✓**"
    ...
    "Packet Injection in 11a/g/n/ac/ax format with 20 MHz Channel bandwidth (CBW)","See :ref:`sdr-tx-20-cbw`","✓(Up to 2x2 MIMO)","**✓**"
    "Packet Injection in 11a/g/n/ac/ax format with 40/80/160 MHz Channel bandwidth (CBW)","See :ref:`sdr-tx-40-or-higher-cbw`","","**✓**"
    "Tx Resampling","See :ref:`non-standard-tx-rx`.","✓(Only 1.0 and 1.25)","**✓**"
    "Rx Resampling","See :ref:`non-standard-tx-rx`.","✓(Only 0.8 and 1.0)","**✓**"
