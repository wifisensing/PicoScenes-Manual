...
.. csv-table::
    ...
    "Record Tx Baseband Signals","See :ref:`signal-recording-replay`","","**✓**"
    "Replay Tx Baseband Signals","See :ref:`signal-recording-replay`","","**✓**"
    "Record Rx baseband Signals","See :ref:`signal-recording-replay`","**✓**","**✓**"
    "Replay Rx baseband Signals","See :ref:`signal-recording-replay`","**✓**","**✓**"
