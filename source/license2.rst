...
.. csv-table::
    ...
    "Tx 11ax High Doppler Format Frames","See :ref:`multi-csi-measurement` and :ref:`tx-rx-midamble`.","","**✓**"
    "Tx 11n Extra Spatial Sounding (ESS) Frames","See :ref:`multi-csi-measurement` and :ref:`tx-rx-ess`.","","**✓**"
