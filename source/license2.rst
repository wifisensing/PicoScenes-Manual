...
.. csv-table:: Features Supported By USRP
    ...
    "Manual Rx gain control","See :ref:`rx_gain_control`","**✓**","**✓**"
    "Tx chain specification","See :ref:`antenna_selection`","✓(Limited, up to 2 channels)","**✓**"
    "Tx chain specification","See :ref:`antenna_selection`","✓(Limited, up to 2 channels)","**✓**"
    "Record Tx baseband signal","Record Tx baseband signal to file","","**✓**"
    "Replay Tx baseband signa","Transmit the pre-generated or recorded Tx baseband signal","","**✓**"
