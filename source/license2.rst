...
.. csv-table:: Features Supported By USRP
    ...
    "Packet Injection in 11a/g/n/ac/ax format with 20 MHz Channel bandwidth (CBW)","See :ref:`sdr-tx-20-cbw`","✓(Limited, up to 2x2 MIMO)","**✓**"
    "Packet Injection in 11a/g/n/ac/ax format with 40/80/160 MHz Channel bandwidth (CBW)","See :ref:`sdr-tx-40-or-higher-cbw`","","**✓**"
    "Tx Resampling","See :ref:`non-standard-tx-rx`","✓(Limited, only 1.0 and 1.25)","**✓**"
    "Rx Resampling","See :ref:`non-standard-tx-rx`","✓(Limited, only 0.8 and 1.0)","**✓**"
