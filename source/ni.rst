...
NI USRP系列历经多年迭代，已经发展出B/E/N/X/NI品牌预组装机五个系列产品。原理上来说，USRP的驱动程序UHD提供了统一的API，PicoScenes可以在所有类型设备上进行Wi-Fi ISAC研究，但 *部分型号由于性价比低、关键特性缺失等因素，我们是不推荐给PicoScenes用户的*。