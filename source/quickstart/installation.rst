...
Mini PCI-E to PCI-E 1x adapter based multi-NIC installation
    ...
    To overcome this issues, you may use some motherboards primarily designed for cryptocurrency mining, such as ASUS B250 Mining Expert. These motherboards have dozens of PCI-E 1x slots and you may use PCI-E slot risers to connect multiple NICs.
